...
public interface OrderDetailMapper {
    ...
    @Insert({
        ...
        "#{total,jdbcType=INTEGER}, #{totalPrice,jdbcType=DOUBLE}, ",
        "#{dishesPrice,jdbcType=DOUBLE}, #{orderId,jdbcType=VARCHAR}, ",
    ...
    @Results({
        ...
        @Result(column="dishes_price", property="dishesPrice", jdbcType=JdbcType.DOUBLE),

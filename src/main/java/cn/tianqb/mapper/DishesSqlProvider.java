...
public class DishesSqlProvider {
    ...
    public String countByExample(DishesExample example) {
        BEGIN();
        SELECT("count(*)");
        FROM("dishes");
    ...
    public String deleteByExample(DishesExample example) {
        BEGIN();
        DELETE_FROM("dishes");
        applyWhere(example, false);
        return SQL();
    ...
    public String selectByExample(DishesExample example) {
        BEGIN();
    ...
    protected void applyWhere(DishesExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
